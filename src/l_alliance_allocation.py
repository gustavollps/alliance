...
from l_alliance_class import Alliance
from alliance.msg import motivation
from alliance.msg import message
from alliance.msg import to_monitor_l
...
robot_00 = Alliance(robot_id=robot_id,
                    theta=2000, rho=7, tau=30, psi=120, phi=360,
...
def publish_monitor():
    ...
    if not msg_filled:
        ...
        monitor_msg.boredom = robot_00.boredom
        monitor_msg.task_category = robot_00.task_category
...
pub_mon = rospy.Publisher("monitor_bus", to_monitor_l, queue_size=10)
pub_mon_single = rospy.Publisher("monitor_bus" + str(robot_id), to_monitor_l, queue_size=10)
